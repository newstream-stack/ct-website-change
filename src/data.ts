    ...
    content: `
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 my-10 md:my-16">
          <div class="w-full aspect-[4/5] bg-theme-text/5 border border-theme-text/10 overflow-hidden transition-colors">
            <img src="https://ct.org.tw/upload/news_article_cms/2026/04/10/10368_4840_%E5%BC%B5%E5%AE%B0%E9%87%91%E7%89%A7%E5%B8%AB_2.jpg" onerror="this.src='https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&q=80&w=800'" class="w-full h-full object-cover hover:scale-105 transition-all duration-700" alt="張宰金牧師授課" />
          </div>
          <div class="w-full aspect-[4/5] bg-theme-text/5 border border-theme-text/10 overflow-hidden md:mt-12 transition-colors">
            <img src="https://ct.org.tw/upload/news_article_cms/2026/04/10/25585_4840_%E5%BC%B5%E5%AE%B0%E9%87%91%E7%89%A7%E5%B8%AB_3.jpg" onerror="this.src='https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&q=80&w=800'" class="w-full h-full object-cover hover:scale-105 transition-all duration-700" alt="會心園諮商" />
          </div>
      </div>
...
export const COLUMNISTS: Columnist[] = [
  {
    id: 'c1',
    name: '文亮',
    avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '好牧人',
    latestArticleTitle: '《真理教室》敬虔三要素',
    latestArticleDate: '2026-04-16',
    latestArticleId: 11
  },
  {
    id: 'c2',
    name: '吳道宗',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '好牧人',
    latestArticleTitle: '重審耶穌的佈道策略',
    latestArticleDate: '2026-04-15',
    latestArticleId: 12
  },
  {
    id: 'c3',
    name: '吳獻章',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '好牧人',
    latestArticleTitle: '【創世紀靈修】過客的眼光',
    latestArticleDate: '2026-04-11',
    latestArticleId: 13
  },
  {
    id: 'c4',
    name: '劉幸枝',
    avatarUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '天路客',
    latestArticleTitle: '【禱嶼專欄8】給「馬大們」的歸心祈禱',
    latestArticleDate: '2026-04-11',
    latestArticleId: 14
  },
  {
    id: 'c5',
    name: '林鴻信',
    avatarUrl: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '國度之聲',
    latestArticleTitle: '【睿智雞精特別號】我們相信人格神或三一神呢？',
    latestArticleDate: '2026-04-08',
    latestArticleId: 15
  },
  {
    id: 'c6',
    ...
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
    subCategory: '國度之聲',
    latestArticleTitle: '神為何不讓大衛建造聖殿？',
    latestArticleDate: '2026-04-07',
    latestArticleId: 16
  }
];
