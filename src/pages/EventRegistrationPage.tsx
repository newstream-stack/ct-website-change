...
export default function EventRegistrationPage({ goToCategory }: EventRegistrationPageProps) {
  ...
  if (registration) {
    ...
    return (
      <div className="pt-[150px] md:pt-[180px] pb-24 px-5 min-h-[100dvh] flex items-center justify-center bg-theme-bg text-theme-text">
  ...
  return (
    <div className="pt-[150px] md:pt-[140px] pb-24 min-h-[100dvh] bg-theme-bg text-theme-text relative">
