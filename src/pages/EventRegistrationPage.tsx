    ...
    return (
      <div className="pt-[190px] md:pt-[180px] pb-24 px-5 min-h-[100dvh] flex items-center justify-center bg-theme-bg text-theme-text transition-colors duration-500">
        <div className="max-w-xl w-full text-center p-12 border border-theme-text/10 rounded-2xl bg-theme-text/5 backdrop-blur-md animate-fade-in-up">
          ...
          <button onClick={() => goToCategory('首頁')} className="bg-brand-red text-white px-8 py-3 rounded-full font-bold tracking-widest hover:bg-brand-red/90 transition-colors">
            回首頁
          </button>
        </div>
      </div>
          ...
          <form id="registration-form" onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2 relative group">
                ...
                <div className="relative">
                  ...
                  <input name="name" type="text" required maxLength={100} autoComplete="name" className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block pl-11 p-3.5 outline-none transition-all focus:ring-1 focus:ring-brand-red/50" placeholder="王大明" />
                </div>
              </div>
              <div className="flex flex-col gap-2 relative group">
                <label className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-theme-text/70 ml-1">稱謂 Title</label>
                <div className="relative">
                  <select name="title" className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block p-3.5 outline-none transition-all appearance-none cursor-pointer">
            ...
            <div className="flex flex-col gap-2 relative group">
              ...
              <div className="relative">
                ...
                <input name="email" type="email" required maxLength={254} autoComplete="email" className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block pl-11 p-3.5 outline-none transition-all focus:ring-1 focus:ring-brand-red/50" placeholder="david@example.com" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 relative group">
              ...
              <div className="relative">
                ...
                <input name="phone" type="tel" required maxLength={30} autoComplete="tel" className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block pl-11 p-3.5 outline-none transition-all focus:ring-1 focus:ring-brand-red/50" placeholder="0912-345-678" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 relative group">
              ...
              <div className="relative">
                ...
                <input name="organization" type="text" maxLength={150} autoComplete="organization" className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block pl-11 p-3.5 outline-none transition-all focus:ring-1 focus:ring-brand-red/50" placeholder="填寫所屬單位名稱" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 relative group mt-2">
              ...
              <textarea name="remarks" rows={3} maxLength={1000} className="w-full bg-theme-text/5 border border-theme-text/20 focus:border-brand-red/50 text-theme-text text-sm rounded-xl block p-3.5 outline-none transition-all focus:ring-1 focus:ring-brand-red/50 resize-none" placeholder="例如：飲食禁忌 (素食) 等..."></textarea>
            </div>
