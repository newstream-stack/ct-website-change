...
function DesktopAd() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 500" className="w-full h-full">
      ...
      <rect x="0" y="0" width="800" height="4" fill="#C62828"/>
      <rect x="0" y="496" width="800" height="4" fill="#C62828"/>
      ...
      <rect x="60" y="60" width="5" height="380" fill="#C62828"/>
      <text x="88" y="155" fontFamily="Georgia, serif" fontSize="78" fontWeight="bold" fill="#ffffff" letterSpacing="6">IMPACT</text>
      <text x="90" y="200" fontFamily="Georgia, serif" fontSize="28" fill="#C62828" letterSpacing="4">論壇報</text>
      ...
      <rect x="88" y="380" width="158" height="46" rx="23" fill="#C62828"/>
      ...
      <text x="611" y="295" fontFamily="Georgia, serif" fontSize="17" fill="#C62828" textAnchor="middle" letterSpacing="3">PREMIUM</text>
      <text x="611" y="318" fontFamily="Georgia, serif" fontSize="17" fill="#C62828" textAnchor="middle" letterSpacing="3">SPONSORSHIP</text>
    </svg>
  );
}
...
function MobileAd() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 750" className="w-full h-full">
      ...
      <rect x="0" y="0" width="500" height="4" fill="#C62828"/>
      <rect x="0" y="746" width="500" height="4" fill="#C62828"/>
      ...
      <text x="250" y="165" fontFamily="Georgia, serif" fontSize="21" fill="#C62828" textAnchor="middle" letterSpacing="4">論壇報</text>
      <rect x="80" y="305" width="340" height="1" fill="#2a2a2a"/>
      <rect x="48" y="335" width="4" height="255" fill="#C62828"/>
      ...
      <rect x="80" y="578" width="340" height="52" rx="26" fill="#C62828"/>
