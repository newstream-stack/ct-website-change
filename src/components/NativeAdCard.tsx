...
export default function NativeAdCard({ ad }: NativeAdCardProps) {
  return (
    <a href={getSafeExternalUrl(ad.link)} target="_blank" rel="noopener noreferrer" className="group relative flex flex-col overflow-hidden bg-theme-bg border-y-2 border-brand-red/30 cursor-pointer col-span-1">
