      ...
      {panels.map((panel, index) => {
        if (panel.type === 'ad') {
          ...
          return (
            ...
            >
              <img src={ad.imageUrl} className="accordion-bg transition-opacity duration-1000 opacity-50 group-hover:opacity-90 grayscale md:grayscale-0" alt="Cover" style={{ zIndex: 1 }} />
