  ...
  return (
    <div className="pt-[210px] md:pt-[190px] pb-40 md:pb-24 bg-theme-bg text-theme-text transition-colors duration-500 min-h-screen">
      ...
      <div className="px-5 md:px-12 lg:px-20 mb-10 md:mb-12">
        <h2 className="text-2xl md:text-4xl font-serif font-black tracking-widest mb-6 md:mb-8 text-theme-text border-b border-theme-text/10 pb-4 md:pb-6 transition-colors">專欄</h2>
        
        <div className="relative aspect-[16/9] md:aspect-[28/10] w-full overflow-hidden rounded-sm group shadow-2xl">
          {/* Slides */}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 lg:p-16">
                 <div className="max-w-4xl animate-fade-in-up">
                    ...
                    <h3 
                      className="text-lg md:text-2xl lg:text-4xl font-serif font-black text-white leading-[1.4] mb-4 md:mb-6 cursor-pointer hover:text-brand-red transition-colors line-clamp-2 md:line-clamp-none"
          ...
          <button 
            onClick={prevSlide}
            className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/30 backdrop-blur-md hover:bg-brand-red text-white items-center justify-center transition-all rounded-full z-30 group/btn"
            title="Previous Slide"
          >
            <i className="fas fa-chevron-left text-xs group-hover/btn:-translate-x-0.5 transition-transform"></i>
          </button>
          <button 
            onClick={nextSlide}
            className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/30 backdrop-blur-md hover:bg-brand-red text-white items-center justify-center transition-all rounded-full z-30 group/btn"
            title="Next Slide"
          >
            <i className="fas fa-chevron-right text-xs group-hover/btn:translate-x-0.5 transition-transform"></i>
          </button>
