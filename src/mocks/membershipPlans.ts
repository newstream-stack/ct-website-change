...
export const MOCK_MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    features: ['數位內容免費閱讀', '每週電子報寄送', '60年資料庫查詢'],
    isPopular: false,
  },
  {
    id: 'plan-b',
    ...
    features: ['數位內容免費閱讀', '每週電子報寄送', '60年資料庫查詢', '本報設計寵鵝好禮', '會員專屬禱告卡或禱告書'],
    isPopular: true,
  },
  {
    id: 'plan-c',
    ...
    features: ['數位內容免費閱讀', '每週電子報寄送', '60年資料庫查詢', '紙本論壇報', '本報設計寵鵝好禮', '會員專屬禱告卡或禱告書'],
    isPopular: false,
  },
];
