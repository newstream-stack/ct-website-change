...
export const MOCK_PLANS: Plan[] = [
  {
    id: 1,
    subtitle: 'Revival亞洲論壇影響力中心2026年隆重獻禮',
    summary: '生命未曾止息，只是正等待。在乾旱與沉默之中，我們有時蜷縮著⋯直到那一刻，甘霖沛降。',
  ...
  },
  {
    id: 2,
    subtitle: '將影響力推向地極',
    summary: '這是一個充滿挑戰的時代，卻也是神正在全地興起領袖的時刻。',
    suggestedAmounts: [3000, 15000, 60000, 100000],
  ...
  },
  {
    id: 3,
    subtitle: '神的愛最美的禮物',
    summary: '送出一份禮品，傳遞一份祝福。誠摯邀請您參與這份愛的行動。',
  ...
  },
  {
    id: 4,
    subtitle: '為偏鄉孩子帶來驚喜',
    summary: '一份捐款，為孩子帶來生命中的驚喜。在偏鄉，許多孩子需要您的關懷。',
    title: '乘著愛的風出發吧！',
  ...
  {
    id: 5,
    subtitle: 'Bloom in 2026',
    summary: '在這劇烈搖晃、不確定的時代裡，我們不是感傷時光流逝，而是充滿信心期待。',
    title: '在你所在之處綻放',
  ...
  },
  {
    id: 6,
    subtitle: '從亞洲開始，影響世界',
    summary: '亞洲正站在全球轉變的中心。IAA 被呼召興起，成為亞洲教會的屬靈引擎。',
